...
class MessageTriageService(
    ...
    fun assess(roomTarget: String): TriageVerdict {
        ...
        val system = buildString {
            ...
            append("configuration or repository history? The bot may investigate any public GitHub ")
            append("repository, plus every repository in the 'taonity' organization. The project that ")
            append("created this bot is taonity/sinair-llm-bot. Say TRUE for any question about this ")
            append("bot's implementation or behavior, including how it works, is deployed, configured, ")
