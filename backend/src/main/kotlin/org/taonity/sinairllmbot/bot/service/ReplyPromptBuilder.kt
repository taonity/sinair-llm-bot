...
class ReplyPromptBuilder(
    ...
    fun build(
        ...
        val system = buildString {
            ...
            append("for example `hello`. Use triple backticks around code. If the entire response ")
            append("would exceed six visible lines (about 135 characters each), you MUST put it inside one ")
            append("triple-backtick block. A triple-backtick block shows roughly ten ")
            ...
            append("it does not work here. Do not use any other markdown: no headings, lists, italics, ")
            append("links or markdown tables.")
