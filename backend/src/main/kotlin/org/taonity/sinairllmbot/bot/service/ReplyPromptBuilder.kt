...
class ReplyPromptBuilder(
    ...
    fun build(
        ...
        val system = buildString {
            ...
            append("block contains. Keep that description outside the block. Put the detailed content ")
            append("next, inside the block. You may add a short conclusion after the block only when it ")
