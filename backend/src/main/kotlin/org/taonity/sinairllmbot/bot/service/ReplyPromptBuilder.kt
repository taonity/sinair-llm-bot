...
class ReplyPromptBuilder(
    ...
    fun build(
        ...
        val system = buildString {
            ...
            append("block contains. Keep that sentence outside the block. If the response would exceed ")
            ...
            append("using short numbered or dash-prefixed lines when the information can be structured; ")
