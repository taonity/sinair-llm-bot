...
import { PacketType, UserStatus } from './protocol.js';
import {
...
const MESSAGE_INTERVAL = parseInt(process.env.CHAT_STUBS_MESSAGE_INTERVAL || '8000', 10);
const EVENT_INTERVAL = parseInt(process.env.CHAT_STUBS_EVENT_INTERVAL || '15000', 10);
...
function handleClientMessage(ws, packet) {
    // Simply broadcast it back so the collector sees it
    send(ws, {
