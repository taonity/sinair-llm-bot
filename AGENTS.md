...
- **Bot internals documentation**: code, prompts, configuration, and tests are the source of truth for how the bot works. Do not create or maintain a parallel bot design document or duplicate implementation details in Markdown, including this file. Keep separate documentation focused on usage, setup, testing, and operations.
